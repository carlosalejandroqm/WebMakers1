    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-toggleable-sm sticky-top">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav mr-0 ml-auto mt-2 mt-lg-0 text-center">
                ...
                <a class="nav-link active" href="../html/categoria.html">Categorias</a>
  ...
  <table class="table table-bordered table-hover"><br>
    <thead class="text-center">
     ...
     <div style="margin-bottom: 15px;">
       <a href="../html/categoria.html"><button type="submit" class="btn btn-success" id="listado">Agregar categoria</button></a>
    </div>
</div>
...
<div class="modal fade" id="exampleModal" data-backdrop="static" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="editarCategoria.php" id="Fcategoria" method="POST">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" id="descri" name="descri" require></textarea>
          </div>
...
var datos=$('#Fcategoria').serialize();
 ...
 $.ajax({
   ...
   success: function(r){
    if(r==1){
      window.alert("La categoria ha sido editada")
      
    }else if(r==2){
      window.alert("La categoria no ha sido editada")
    }else if(r==3){
