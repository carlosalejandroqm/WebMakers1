...
<!--Carousel -->
  <div id="carrusel" class="carousel slide carousel-fade " data-ride="carousel">
    ...
    <!--Tabla -->
    <div class="container text-center mt-4" id="tabla">
    ...
    <table class="table table-bordered table-hover"><br>
      ...
      <div style="margin:15px;">
        <a href="empresa.php"><button type="submit" class="btn btn-success" id="listado">Agregar Empresa</button></a>
      </div>
      </tbody>
      </table>
    </div>
...
<div class="modal fade" id="exampleModal" data-backdrop="static" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="editarEmpresa.php" id="Fcategoria" method="POST">
          <div class="form-group">
            <p id="espacio"></p>
            <label for="recipient-name" class="col-form-label">Nombre</label>
            <input type="text" class="form-control" id="nombre" name="nombre" id="recipient-name" require>
          </div>
          <div class="form-group">
            <label for="message-text" class="col-form-label">Quienes somos</label>
            <textarea class="form-control" id="qsomos" name="qsomos" require></textarea>
          </div>
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">Telefono</label>
            <input type="text" class="form-control" id="tele" name="tele" id="recipient-name" require>
          </div>
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">Direccion</label>
            <input type="text" class="form-control" id="direc" name="direc" id="recipient-name" require>
          </div>
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">Email</label>
            <input type="text" class="form-control" id="email" name="email" id="recipient-name" require>
          </div>
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">Facebook</label>
            <input type="text" class="form-control" id="face" name="face" id="recipient-name" require>
          </div>
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">Twitter</label>
            <input type="text" class="form-control" id="twi" name="twi" id="recipient-name" require>
          </div>
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">Instagram</label>
            <input type="text" class="form-control" id="insta" name="insta" id="recipient-name" require>
          </div>
...
var datos=$('#Fcategoria').serialize();
 ...
 $.ajax({
   ...
   success: function(r){
    if(r==1){
      window.alert("La Empresa ha sido editada")
      
    }else if(r==2){
      window.alert("La Empresa no ha sido editada")
    }else if(r==3){
...
var datos=$('#Fcategoria').serialize();
 ...
 $.ajax({
   ...
   success: function(r){
    if(r==1){
      window.alert("La categoria ha sido eliminada")
    }else{
      window.alert("La categoria no ha sido eliminada")
    }
   }
 });
 return false;
